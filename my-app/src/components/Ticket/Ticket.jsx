      ...
      <div className="ticket__container">
        <div className="ticket__text-box">
          ...
          <div className="ticket__group ticket__group--count">
            <button className="ticket__shape" onClick={handleRemoveTicket}>
              -
            </button>
            <p>{ticketCount}</p>
            <button className="ticket__shape" onClick={handleAddTicket}>
              +
            </button>
          </div>
        </div>
        <div className="ticket__btn" onClick={handleReserveTicket}>
          RESERVE TICKET
        </div>
      </div>
    </div>
